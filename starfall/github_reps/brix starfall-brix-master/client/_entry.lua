--@include starfall-brix-master/client/scenes/scene.lua
--@include starfall-brix-master/client/gui.lua
--@include starfall-brix-master/client/gfx.lua
--@include starfall-brix-master/br/arena_cl.lua
--@include starfall-brix-master/client/settings.lua
--@include starfall-brix-master/client/input.lua

--@includedir brix/client/game


require("starfall-brix-master/client/settings.lua")
require("starfall-brix-master/br/arena_cl.lua")
require("starfall-brix-master/client/gui.lua")
require("starfall-brix-master/client/gfx.lua")
require("starfall-brix-master/client/input.lua")
require("starfall-brix-master/client/scenes/scene.lua")

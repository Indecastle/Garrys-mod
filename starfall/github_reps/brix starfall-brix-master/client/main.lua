...
--@client
--@include starfall-brix-master/client/lite/lite.lua
--@include starfall-brix-master/client/loader.lua
--@include starfall-brix-master/client/_entry.lua
--[[
...
require("starfall-brix-master/client/lite/lite.lua")
require("starfall-brix-master/client/loader.lua")

hook.add("load", "", function()

	require("starfall-brix-master/client/_entry.lua")

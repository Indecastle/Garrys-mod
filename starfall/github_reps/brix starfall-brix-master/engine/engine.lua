...
--@shared
--@include starfall-brix-master/engine/matrix.lua
--@include starfall-brix-master/engine/move.lua
--@include starfall-brix-master/engine/damage.lua
--@include starfall-brix-master/engine/piecegen.lua
--@include starfall-brix-master/engine/mainloop.lua
--@include starfall-brix-master/engine/coroutine.lua
...
brix.params = {
	...
	are = 7,				-- Number of frames between matrix collapse (or lockdown, if no lines cleared), and the next piece appearing.
	are_charge = false,		-- Whether to allow "charging" of auto-repeat shifting during ARE
